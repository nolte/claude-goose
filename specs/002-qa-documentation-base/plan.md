...
| II. Plans Are Versioned Artifacts | Revisions carry ids; the maintenance procedure declares its stages with completion conditions | **PASS** — revision ids exist; the procedure is specified in Phase 1 |
...
not be duplicated per revision.

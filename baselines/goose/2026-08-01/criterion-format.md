# Criterion Format — Revision 2026-08-01
...
| `version_range` | yes | The host versions the expectation holds for. **Mandatory from this revision on**: an unversioned claim about versioned behaviour is invalid, not merely imprecise — a reader cannot tell whether it still applies, and a drift check cannot tell whether it needs re-measuring |
